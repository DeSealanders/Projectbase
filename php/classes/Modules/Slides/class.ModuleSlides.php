...
class ModuleSlides extends Module {
    ...
    public function __construct() {
        ...
        $this->addComponent(new NumberboxComponent('X-coordinate', 'xpos', '', '', 100, false, 0, 'group1'));
        $this->addComponent(new NumberboxComponent('Y-coordinate', 'ypos', '', '', 100, false, 0, 'group1'));
